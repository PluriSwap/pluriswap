...
export const PATHS: PathTemplate[] = [
  ...
  },
  {
    id: "PATH-ARB-MOCK",
    group: "tribunal",
    teaches: "Con ARB siempre DISPUTED primero. openCourt kernel → impl. El mock cobra courtFee en ERC-20 al court (approve al módulo, no al escrow); msg.value = 0.",
    recintoHint: "packages",
    ...T("3600", "1800", "7200", String(86_400)),
    p2p: true,
    needs: ["packages", "labVerbs", "zkArb"],
    sequence: "court=ArbitrationMock; approve court; msg.value=0; markFiat; openDisputed; openCourt; LAB submitRuling; readRuling",
    ...
    steps: [
      ...
      { verb: "openDisputed", seat: "Controller", space: "deal", expect: "DISPUTED" },
      ...
      { verb: "readRuling", seat: "anyone", space: "deal", expect: "RESOLVED_BY_ARBITRATION (1, 2 o 3 = no gana ninguno)" },
    ],
  },
  {
    id: "PATH-KLEROS",
    ...
    p2p: true,
    needs: ["packages", "zkArb"],
    sequence: "P2P dummy CA; kernel() vs Recinto; msg.value == arbitrationCost; markFiat; openDisputed; openCourt",
    ...
    steps: [
      ...
      { verb: "readRuling", seat: "anyone", space: "deal", expect: "RESOLVED_BY_ARBITRATION (Holder / Provider / ninguno)" },
    ],
  },
  {
    id: "PATH-POOL-HOLDER",
