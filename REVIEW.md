...
8. Contest-open (2026-09-17). **Hecho.** Reputación oficial declara `contestFee` no-cero y lo bindea al `packageId`. El kernel lo cobra una vez al abrir `DISPUTED` o corte desde `FIAT_SENT`, de la wallet del opener. Core-only sigue gratis. Allowance corta: reject. Drift: fee 0.
