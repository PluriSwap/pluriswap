...
En la capa pública el módulo lo lleva en un mapping `credited[subject][counterparty]`. En la privada no puede haber mapping —publicaría el grafo de comercio— y se prueba **dentro del circuito** contra el árbol de contrapartes que la hoja lleva (§3.15.5).
