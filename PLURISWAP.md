...
| Ítem | Estado |
| --- | --- |
| Verifier ZK real | El camino ZK de testnet usa `VerifierMock` (acepta cualquier `abi.encode(dealId, nullifier)`): no es un proof. Pendiente de circuito real. Precondición cerrada el 2026-09-24: los términos firman la pata fiat (`fiatCommit`, §3.13) |
