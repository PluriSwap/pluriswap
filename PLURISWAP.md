...
| F3 | Vault: split, `reabsorb` con gating, `withdraw` sin passport | Cierre contractual (2026-09-21): los 4 verbos del kernel ejercitados (`slash` vía ruling real), invariants de conservación verde; el verifier real sigue pendiente |
