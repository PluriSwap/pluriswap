...
| REPUTATION | `IReputation` | `reputation(module, feeRecipient, activationFee, completionFee)` |
...
id_rep      = keccak256(abi.encode(REPUTATION_KIND, module, feeRecipient, activationFee, completionFee))
